...
namespace MIS_API.Migrations
{
    ...
    [Migration("20230101125222_MadeTaskOptional")]
    partial class MadeTaskOptional
    {
            ...
            modelBuilder.Entity("MIS_API.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AcceptTerms = false,
                            Created = new DateTime(2023, 1, 1, 12, 52, 21, 782, DateTimeKind.Local).AddTicks(1633),
                            Email = "info@mis.org",
                            FirstName = "The Supreme",
                            LastName = "Knight",
                            MiddleName = " SK",
                            PasswordHash = "$2b$10$6j/c3A2MlTZ1GmBhsvnQo.R0eNiDJqMYlIcNsf2wsfeY.Ln/VAVV2",
                            RoleId = 1,
                            Verified = new DateTime(2023, 1, 1, 12, 52, 21, 782, DateTimeKind.Local).AddTicks(1887)
                        });
                });
            ...
            modelBuilder.Entity("MIS_API.Entities.Roles.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 1, 1, 12, 52, 21, 650, DateTimeKind.Local).AddTicks(4937),
